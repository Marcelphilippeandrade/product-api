...
public class ProdutoControllerAdvice {
	...
	public ErrorDTO handleUsarioNotFound(ProdutoNotFoundException produtoNotFoundException) {
	...
	public ErrorDTO handleCategoriaNotFound(CategoriaNotFoundException categoriaNotFoundException) {
		ErrorDTO errorDTO = new ErrorDTO();
		errorDTO.setStatus(HttpStatus.NOT_FOUND.value());
